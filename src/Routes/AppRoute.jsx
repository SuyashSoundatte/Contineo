...
// Import the BrokenComponent
const BrokenComponent = lazy(() => import("../components/BrokenComponent.jsx"));
...
const ClassTeacherAllocate = lazy(
  () => import("../components/ClassTeacherAllocate.jsx")
);
...
const StudentMasterForm = lazy(
  () => import("../components/StudentMasterForm.jsx")
);
const SubjectForm = lazy(() => import("../components/SubjectForm.jsx"));
const TeacherForm = lazy(() => import("../components/TeacherForm.jsx"));
const TeacherMasterForm = lazy(
  () => import("../components/TeacherMasterForm.jsx")
);
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            <Route path='/MainPage' element={<MainPage />}>
              ...
              <Route
                path='ViewComponent/:user_id'
                element={<ViewComponent />}
              />
              <Route
                path='TeacherMasterForm/:user_id'
                element={<TeacherMasterForm />}
              />
            </Route>
          </Routes>
        </Suspense>
